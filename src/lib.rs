//! Native connector ABI for Couchbase.
//!
...
const HEALTH_RESPONSE_JSON: &str =
    r#"{"ok":true,"engine":"couchbase","abiVersion":1,"driverLinked":false}"#;
const DESCRIBE_RESPONSE_JSON: &str = concat!(
    r#"{"ok":true,"engine":"couchbase","abiVersion":1,"driverLinked":false,"manifest":"#,
